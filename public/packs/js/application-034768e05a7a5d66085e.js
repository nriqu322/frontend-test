...
_rails_activestorage__WEBPACK_IMPORTED_MODULE_2__["start"](); // window.home = home
...
document.addEventListener('turbolinks:load', function () {
  ...
  clickVector.addEventListener('click', function () {
    var element = document.getElementById("text-one"); // let arrow = document.getElementById("vector-one");

    element.classList.toggle("no-display"); // if (element.classList.contains == "no-display") {
    //   element.classList.remove("no-display");
    // } else {
    //   element.classList.add("no-display");
    // }
...
/******/ });
//# sourceMappingURL=application-034768e05a7a5d66085e.js.map