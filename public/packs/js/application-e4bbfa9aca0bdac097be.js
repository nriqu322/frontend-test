...
/* harmony import */ var _home__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./home */ "./app/javascript/packs/home.js");
/* harmony import */ var _home__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_home__WEBPACK_IMPORTED_MODULE_4__);
...
window.home = _home__WEBPACK_IMPORTED_MODULE_4___default.a;
...
function displayItem() {
  // let element = document.getElementById("text-one");
  // let arrow = document.getElementById("vector-one");
  console.log('clicked'); // if (element.classList.contains === "no-display") {
  //   element.classList.remove("no-display");
  // } else {
  //   element.classList.add("no-display");
  // }
  // if (arrow.classList.contains === "vector-up") {
  //   arrow.classList.remove("vector-up");
  //   arrow.classList.add("vector-down");
  // } else if (arrow.classList.contains === "vector-down") {
  //   arrow.classList.remove("vector-down");
  //   arrow.classList.add("vector-up");
  // }
}

document.addEventListener('turbolinks:load', function () {
  // const textOne = "text-one";
  // const vectorOne = "vector-one";
  var clickVector = document.getElementById("button-click");
...
/******/ });
//# sourceMappingURL=application-e4bbfa9aca0bdac097be.js.map