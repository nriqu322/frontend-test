...
function displayItem(text, vector) {
  var element = document.getElementById(text);
  var arrow = document.getElementById(vector);
  console.log('clicked');
...
document.addEventListener('turbolinks:load', function () {
  ...
  clickVector.addEventListener('click', displayItem(textOne, vectorOne));
});
...
/******/ });
//# sourceMappingURL=application-9bde20136da082240fef.js.map