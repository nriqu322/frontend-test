...
document.addEventListener('turbolinks:load', function () {
  ...
  var clickVector = document.querySelectorAll(".vector");
  console.log(clickVector);
  clickVector.forEach(function (arrow) {
    arrow.addEventListener('click', function () {
      ...
      //   arrow.classList.replace("vector-up", "vector-down");
      // } else {
      //   arrow.classList.replace("vector-down", "vector-up");
      // }
      if (arrow.classList.contains == "vector-up") {
        arrow.classList.replace("vector-up", "vector-down"); // arrow.classList.add("vector-down");
      } else if (arrow.classList.contains == "vector-down") {
        arrow.classList.replace("vector-down", "vector-up"); // arrow.classList.add("vector-up");
      }
    });
  });
});
...
/******/ });
//# sourceMappingURL=application-03d5f78f011ec6a25487.js.map